...
#         #2 gates is the least to make it make sense
#         if width >= (VERTIPORT_SIDE * 2 + GATE_SIDE * 2) or length >= (VERTIPORT_SIDE * 2 + GATE_SIDE * 2):
#             print("Both Long Enough If Safety Area Needed")
#             return(True)
#         elif width >= ((VERTIPORT_SIDE * 2 + GATE_SIDE * 2) - SAFETY_SIDE) or length >= ((VERTIPORT_SIDE * 2 + GATE_SIDE * 2) - SAFETY_SIDE):
#             print("Long Side Is Too Short If Safety Area is Needed")
#             return(True)
#         else:
#             return(False)
#     elif width >= (VERTIPORT_SIDE + TAXIWAY_SIDE - SAFETY_SIDE) and length >= (VERTIPORT_SIDE + TAXIWAY_SIDE - SAFETY_SIDE):
#         if width >= (VERTIPORT_SIDE * 2 + GATE_SIDE * 2) or length >= (VERTIPORT_SIDE * 2 + GATE_SIDE * 2):
#             print("Short Side Is Too Short If Safety Area Needed")
#             return(True)
#         elif width >= ((VERTIPORT_SIDE * 2 + GATE_SIDE * 2) - SAFETY_SIDE) or length >= ((VERTIPORT_SIDE * 2 + GATE_SIDE * 2) - SAFETY_SIDE):
#             print("Both Too Short If Safety Area Needed")
#             return(True)
#         else:
#             return(False)
#     else:
...
def calculate_flights_triple2(vertiports, waitTime):    
    cycleTime = TAKELAND_TIME + waitTime
    numFlights = (60/cycleTime) * (vertiports)
    return(numFlights)
...
if check_area_triple2(areaWidth, areaLength) == True:
    ...
    numFlightsVert = calculate_flights_triple2(vertiportsVert, waitTimeVert)
